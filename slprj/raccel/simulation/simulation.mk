...
MODEL                  = simulation
MODULES                = MW_pigs.c system.c rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c simulation.c simulation_capi.c simulation_data.c simulation_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
...
MASTER_ANCHOR_DIR      = 
START_DIR              = C:\Users\computer\Desktop\git\closed-loop-speed-controller
...
ADDITIONAL_LDFLAGS   = 
DEFINES_CUSTOM       = -DRSIM_WITH_SOLVER_MULTITASKING 
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = simulation_ref.rsp
MODELREF_INC_PATH         = 
COMPILER_COMMAND_FILE     = simulation_comp.rsp
...
BUILDINFO_INCLUDES = $(BUILDINFO_INCLUDES);C:\ProgramData\MATLAB\SupportPackages\R2018b\toolbox\realtime\targets\raspi\server

BUILDINFO_INCLUDES = $(BUILDINFO_INCLUDES);C:\ProgramData\MATLAB\SupportPackages\R2018b\toolbox\realtime\targets\linux\include

BUILDINFO_INCLUDES = $(BUILDINFO_INCLUDES);$(START_DIR)\slprj\raccel\simulation
